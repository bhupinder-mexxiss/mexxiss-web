            ...
            <div className="">
              <div className="text-center">
                <div className="text-center">
                  ...
                  <h1 className="mt-6 text-5xl font-bold text-heading leading-[52px] ">
                    Machinery Solutions
                  </h1>
      ...
      <div className="-mt-[50px]">
        <div className="container mx-auto">
          <div className="grid grid-cols-9 gap-5">
            <div className="card relative p-4 flex items-center justify-center flex-col border-2 border-primary border-opacity-80 shadow-[0_0.5rem_1rem_rgba(0,0,0,0.15)] bg-white rounded min-h-[100px] hover:bg-[#ffd4d4] duration-300">
              <Link
                to="/products"
