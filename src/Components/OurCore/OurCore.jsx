      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-2 items-center">
          ...
          <div className="relative">
            ...
            <div className="px-6 py-4 absolute -bottom-10 left-[35%] flex items-center gap-6 shadow-[5px_4px_50px_rgba(0,0,0,0.1)] z-10 bg-white rounded">
              <img src={user} className="w-14" />
              <div>
                <h6 className="text-primary text-3xl font-semibold mb-2">
                  3800+
                </h6>
                <p className="text-text1 font-medium">Happy Clients</p>
              </div>
            </div>
          </div>
        </div>
